...
function HomePage({ posts, setPosts,deletePost }) {
  ...
  return (
    <div className="h-screen w-full justify-center ">
      <div className="flex justify-between items-center w-full h-20 pl-4 pr-4 bg-[#ffffff] fixed z-20 top-0 left-0 right-0 ">
      ...
      <FeedPost posts={posts} setPosts={setPosts} deletePost={deletePost}/>
