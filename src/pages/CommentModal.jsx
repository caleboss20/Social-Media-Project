  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      >
        ...
        {/* bottom input */}
        <div className="p-1 border-t flex items-center gap-3 ">
          <input
            value={input}
            onChange={(e) => setInput(e.target.value)}
            placeholder="Add a comment..."
            className="flex-1 px-4 py-2 rounded-full border border-gray-300 text-lg placeholder:text-base focus:outline-none focus:ring-1 focus:ring-blue-400"
          />
          <button
            onClick={handlePost}
